<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitSaleEditCDS.aspx.cs" Inherits="UI_UnitSaleEntry" Title=" Unit Sale Entry Form (Design and Developed by Sakhawat)" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <tr>
        ...
        <td align="left">
            <asp:TextBox ID="saleNumberTextBox" runat="server" 
                ...
                onkeypress="fncInputNumericValuesOnly()" Height="21px"></asp:TextBox>
     ...
     <tr>
        ...
        <td align="left">
            <asp:TextBox ID="MoneyReceiptNoTextBox" runat="server" 
                    ...
                    meta:resourcekey="saleNumberTextBoxResource1" 
                    onkeypress= "fncInputNumericValuesOnly()" Height="18px" Enabled="False"></asp:TextBox></td>
        ...
        <td align="left"> 
                ...
                &nbsp;
                    ...
                    meta:resourcekey="regNoTextBoxResource1" Width="95px" 
                        ontextchanged="regNoTextBox_TextChanged" Enabled="False"></asp:TextBox>
                                    </td>
    </tr>
     <tr>
     ...
     <table width="1100" align="center" cellpadding="0" cellspacing="0" border="0" >
      <tr>
        ...
        <asp:Button ID="DeleteButton" runat="server" Text="Delete" OnClientClick="return fnConfirmDelete();"
                CssClass="buttoncommon"  AccessKey="" onclick="DeleteButton_Click" />
