<%@ Page Language="C#" MasterPageFile="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitJointEntry.aspx.cs" Inherits="UI_UnitJointEntry" Title="Registration Entry Form (Design and Developed by Sakhawat)" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" 
        ...
        Unit Joint Holder Entry Form (<span id="spanFundName" runat="server"></span>)
            </td>           
            ...
            <table align="left" cellpadding="0" cellspacing="0" border="0" 
                ...
                <tr>
                    ...
                    <span class="style3">|</span><asp:HyperLink ID="HyperLink1" runat="server" 
                            NavigateUrl="~/UI/UnitJointEntry.aspx" Font-Bold="True" ForeColor="White">Joint Holder Information</asp:HyperLink>
                    </td>
        ...
        <td align="left">
          &nbsp;  
            <asp:Label ID="NameLabel" runat="server" 
                style="font-weight: 700; font-size: medium;" ForeColor="#339933"></asp:Label>
                                                    </td> 
           ...
           &nbsp; <asp:Label ID="CIPLabel" runat="server" Text="" 
                ...
                <td align="right"> <b>Is ID Account:</b>   </td>        
                 ...
                 <td align="left"> &nbsp; <asp:Label ID="IDLabel" runat="server" Text="" 
                         style="font-weight: 700; font-size: medium;" ForeColor="#339933"></asp:Label>    </td>
   ...
   <tr>
    ...
    <tr>
             ...
             <asp:TextBox ID="TelphoneTextBox" runat="server" 
                CssClass= "TextInputStyleLarge" MaxLength="30" TabIndex="34" 
                      meta:resourcekey="holderTelphoneTextBoxResource1"></asp:TextBox>
                                </td>
        <td align="right"><b>E-Mail:</b></td>
        <td align="left">
             <asp:TextBox ID="EmailTextBox" runat="server" 
                CssClass= "TextInputStyleLarge" MaxLength="30" TabIndex="35" 
