...
public partial class ReportViewer_UnitReportStatementAfterClosingReportViewer : System.Web.UI.Page
{
    ...
    AMCL.REPORT.CR_UnitStatementAfterClosing CR_StatementAfterClosing = new AMCL.REPORT.CR_UnitStatementAfterClosing();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       if (BaseContent.IsSessionExpired())
        ...
        string closingDate = (string)Session["closingDate"];
        ...
        //dtUnitHolderInfo.WriteXmlSchema(@"D:\Project\Web\AMCL.OPENMF\AMCL.REPORT\XMLSCHEMAS\dtUnitHolderStatementAfterClosing.xsd");


            CR_StatementAfterClosing.Refresh();
            CR_StatementAfterClosing.SetDataSource(dtUnitHolderInfo);
            CR_StatementAfterClosing.SetParameterValue("FY", FY);
            CR_StatementAfterClosing.SetParameterValue("closingDate", closingDate);
