<%@ Page Language="C#" MasterPageFile="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitReportTaxStatementAcc.aspx.cs" Inherits="UI_UnitReportTaxStatementAcc" Title=" Tax Certificate Report Form (Design and Developed by Sakhawat)" %>
 ...
 <table align="center">
        <tr>
            <td class="FormTitle" align="center">
                Income Tax Statement Report For Accounts Form (<span id="spanFundName" runat="server"></span>)
            </td>           
            <td>
                <br />
            </td>
