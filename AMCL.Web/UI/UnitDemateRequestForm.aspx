<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitDemateRequestForm.aspx.cs" Inherits="UI_UnitDemateRequestForm" Title="Unit Demate Request Form  (Design and Developed by Sakhawat)" %>
    ...
    <script language="javascript" type="text/javascript"> 
      ...
      function fnCheckInputForList()
      {
        ...
        function fnCheckInputForSubmit()
        {
            ...
            var Confrm = confirm("Are Sure To Sumbit Demate Request for the Selected Sale ");
            if (Confrm) {
                return true;
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
        ...
        <tr>
           ...
           Unit Dematerialization Request Form(<span id="spanFundName" runat="server"></span>)
            </td>           
     ...
     <table width="1100" align="left" cellpadding="0" cellspacing="0" border="0" >
        ...
        <asp:TextBox ID="toSaleNoTextBox" runat="server"
          ...
          <tr>
            <td class="auto-style3">
                <strong>&nbsp;DR Reference No:</strong></td>
            <td align="left" class="style1">
      ...
      <tr>
        <td class="auto-style2" colspan="3" ><asp:Button ID="SubmitButton" runat="server" Text="Submit Demate Request" OnClientClick="return fnCheckInputForSubmit();"
