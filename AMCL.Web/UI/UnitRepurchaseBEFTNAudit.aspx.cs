...
public partial class UI_UnitRepurchaseBEFTNAudit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DataTable dtBEFTNData = unitRepBLObj.dtGetBEFTNData(" AND A.AUDITED_BY IS  NULL");
    ...
    protected void fundNameDropDownList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            DataTable dtBEFTNData = unitRepBLObj.dtGetBEFTNData("AND A.AUDITED_BY IS  NULL AND FUND_INFO.FUND_CD='" + fundNameDropDownList.SelectedValue.ToString() + "'");
            SurrenderListGridView.DataSource = dtBEFTNData;
            SurrenderListGridView.DataBind();
        }
        else
