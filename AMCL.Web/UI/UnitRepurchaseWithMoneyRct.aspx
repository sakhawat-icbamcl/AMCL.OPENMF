<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitRepurchaseWithMoneyRct.aspx.cs" Inherits="UI_UnitRepurchaseWithMoneyRct" Title="Unit Repurchase Entry (Design and Developed by Sakhawat)" %>
 ...
 function fnReset()
  {
      var Confrm=confirm("Are Sure To Resete");
        if(confirm)
        {
             document.getElementById("<%=moneyReceipDropDownList.ClientID%>").value ="0";
         ...
         if( document.getElementById("<%=moneyReceipDropDownList.ClientID%>").value =="0")
               {
                ...
                alert("Please Select Repurchase Number ");
                return false;
               }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
      ...
      <div id="dvContent" runat="server" class="auto-style2" >
          <div  id="dvLeftContent" style=" float:left;"">
    ...
    <colgroup width="350"></colgroup>
        ...
        <tr>
            <td align="left" class="auto-style1" >Repurchase Date:</td>
            <td align="left" class="auto-style1">
                <asp:TextBox ID="RepDateTextBox" runat="server" 
        ...
        <tr>
            ...
            <td align="left" >
                <asp:TextBox ID="RepRateTextBox" runat="server" 
                    CssClass= "TextInputStyleSmall"   Enabled= "false" Width="100px" 
                    Font-Bold="True" ></asp:TextBox>
                                    </td>
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="HolderNameTextBox" runat="server" 
                    CssClass= "TextInputStyleLarge" MaxLength="55" TabIndex="6" Enabled="False"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                 <asp:TextBox ID="HolderJNameTextBox" runat="server" 
                    CssClass= "TextInputStyleLarge" MaxLength="55" TabIndex="7" Enabled="False"></asp:TextBox></td>
            ...
            <td align="left">
                  <table>
                    <tr>
                         ...
                         <td>
                             <asp:Label ID="payTypeLabel" runat="server" Font-Bold="True" Text="payType" Font-Size="Small"></asp:Label>
                        </td>
          ...
          <div style="border-style: solid; border-color: inherit; border-width: 1px; width:229px; float:left; height:153px;">
                ...
                <tr style=" height:15px;">
                  ...
                  <asp:Image ID="SignImage" runat="server" Height="135px" Width="227px"  />
                    </td>    
                </tr>
