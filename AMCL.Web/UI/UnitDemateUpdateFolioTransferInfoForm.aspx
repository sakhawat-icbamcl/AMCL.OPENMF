<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitDemateUpdateFolioTransferInfoForm.aspx.cs" Inherits="UI_UnitDemateUpdateFolioTransferInfoFormm" Title="Unit Demate Update FOLIO Transfer Information Form  (Design and Developed by Sakhawat)" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
        ...
        <tr>
           ...
           Unit Update Folio Transfer Information Form(<span id="spanFundName" runat="server"></span>)
            </td>           
     ...
     <table width="850" align="left" cellpadding="0" cellspacing="0" border="0" >
        ...
        <tr>
          ...
          <tr>
            <td class="auto-style3">
                <strong>Select Folio Transer Reference No:</strong></td>
      ...
      <tr>
        <td class="auto-style2" colspan="5" ><asp:Button ID="SubmitButton" runat="server" Text="Update Folio Transfer Information" 
                    ...
                    <tr>
                        <td>
                         <div id="dvGridSurrender" runat="server"  >
                                ...
                                <ItemTemplate>
                                    <asp:TextBox ID="TRSeqNoTextBox" runat="server"  Text='<%# DataBinder.Eval(Container.DataItem,"TR_SEQ_NO") %>' />
                                </ItemTemplate>
                                </asp:TemplateField>                                                                                                                                                                                                                                           
                                </Columns>
                                </asp:GridView>
