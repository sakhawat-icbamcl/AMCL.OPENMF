    ...
    protected void PrintButton_Click(object sender, EventArgs e)
     {
        ...
        if (IDRadioButton.Checked && BankRadioButton.Checked)
        {
           ...
           sbMaster.Append(" DIVIDEND_ID.BK_BR_NM_CD AS H_BK_BR_NM_CD, BANK_NAME.BANK_NAME || ' , ' || BANK_BRANCH.BRANCH_NAME AS HNAME, BANK_BRANCH.BRANCH_ADDRS1 AS ADDRS1, BANK_BRANCH.BRANCH_ADDRS2 AS ADDRS2, BANK_BRANCH.BRANCH_DISTRICT AS CITY, ");
           sbMaster.Append(" DIVIDEND_ID.BK_FLAG,DIVIDEND_ID.ID_FLAG,DIVIDEND_ID.CIP ,");
        ...
        {
            sbMaster.Append("SELECT FUND_CD,FUND_NM,DIVI_NO,F_YEAR,CLOSE_DT,DIVI_RATE,BK_AC_NO ,BK_AC_NO_MICR||'C' AS BK_AC_NO_MICR,BK_NAME, BK_ADDRS1, BK_ADDRS2, BK_ROUTING_NO,BK_ROUTING_NO||'A' AS BK_ROUTING_NO_MICR,TIN,");
            sbMaster.Append(" BK_TRANSACTION_CODE, TO_CHAR(ISS_DT, 'DD-MON-YYYY') AS ISS_DT, HNAME, REG_NO, JNT_NAME, ADDRS1, ADDRS2, CITY, SPEC_IN1,SPEC_IN2,BK_FLAG,HOLDER_BK_ACC_NO,HOLDER_BK_NM_CD,HOLDER_BK_BR_NM_CD,");
            sbMaster.Append(" LPAD(WAR_NO, 7, '0') AS WAR_NO, 'C'||LPAD(WAR_NO, 7, '0')||'C' AS WAR_NO_MICR,NO_OF_UNITS, TOT_DIVI, TAX_DIDUCT, FI_DIVI_QTY, CIP_QTY, CIP_RATE, CIP, CIP_SL_NO,");
            ...
            sbMaster.Append(" AS CLOSE_DT,NVL(U_MASTER.TIN,'') AS TIN,DIVI_PARA.RATE AS DIVI_RATE, DIVI_PARA.BK_AC_NO,DIVI_PARA.BK_AC_NO_MICR,DIVI_PARA.BK_NAME, DIVI_PARA.BK_ADDRS1, DIVI_PARA.BK_ADDRS2,");
            ...
            sbMaster.Append(" REG_NO,DIVIDEND.REG_NO AS REG_NUM, U_JHOLDER.JNT_NAME,   U_MASTER.ADDRS1,");
            ...
            sbMaster.Append(" U_MASTER.SPEC_IN1,U_MASTER.SPEC_IN2,U_MASTER.BK_FLAG,U_MASTER.BK_AC_NO AS HOLDER_BK_ACC_NO,U_MASTER.BK_NM_CD AS HOLDER_BK_NM_CD,U_MASTER.BK_BR_NM_CD AS HOLDER_BK_BR_NM_CD,");
