<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitDemateUpdateDRNForm.aspx.cs" Inherits="UI_UnitDemateUpdateDRNForm" Title="Unit Demate Update DRN Information Form  (Design and Developed by Sakhawat)" %>
      ...
      function fnCheckInputForSubmit()
        {
                ...
                if (document.getElementById("<%=DRFNoTextBox.ClientID%>").value == "")
                {
                    document.getElementById("<%=DRFNoTextBox.ClientID%>").focus();
                    alert("Please Enter DRF  Number ");
                    return false;
                }
                if (document.getElementById("<%=DRNTextBox.ClientID%>").value == "")
                {
                    document.getElementById("<%=DRNTextBox.ClientID%>").focus();
                    alert("Please Enter DRN ");
                    return false;
                }
                if (document.getElementById("<%=DamateDateTextBox.ClientID%>").value == "")
                {
                    document.getElementById("<%=DamateDateTextBox.ClientID%>").focus();
                    alert("Please Enter DRN Date");
                    return false;
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
        ...
        <tr>
           ...
           Unit Update DRN Information Form(<span id="spanFundName" runat="server"></span>)
            </td>           
     ...
     <table width="850" align="left" cellpadding="0" cellspacing="0" border="0" >
        ...
        <asp:TextBox ID="DRFNoTextBox" runat="server" 
        ...
        <asp:TextBox ID="DRNTextBox" runat="server"
          ...
          <tr>
            ...
            <td align="left" class="auto-style6">
                <asp:TextBox ID="DamateDateTextBox" runat="server" CssClass="textInputStyleDate" meta:resourcekey="saleDateTextBoxResource1" TabIndex="6" Width="130px"></asp:TextBox>
                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="True" Format="dd-MMM-yyyy" PopupButtonID="chequeDateImageButton" TargetControlID="DamateDateTextBox" />
      ...
      <tr>
        <td class="auto-style2" colspan="4" ><asp:Button ID="SubmitButton" runat="server" Text="Update DRN Information" 
                CssClass="auto-style1"  Width="173px" Height="22px" OnClientClick="return fnCheckInputForSubmit();"
