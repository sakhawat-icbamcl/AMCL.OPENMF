<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitRepurchaseWithMoneyRct111.aspx.cs" Inherits="UI_UnitRepurchaseWithMoneyRct" Title="Unit Repurchase Entry (Design and Developed by Sakhawat)" %>
        ...
        <tr>
            ...
            <td align="left" >
                <asp:TextBox ID="RepRateTextBox" runat="server"  MaxLength="6" 
                    CssClass= "TextInputStyleSmall" TabIndex="3" Enabled="False"></asp:TextBox>
                                    </td>
        ...
        <tr>
            ...
            <td align="left">
                ...
                &nbsp;
                    ...
                    CssClass= "TextInputStyleSmall" TabIndex="0"    Width="86px" Enabled="False"></asp:TextBox>
                                    </td>
