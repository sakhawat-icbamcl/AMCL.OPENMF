<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitSaleEntryWithMoneyRct.aspx.cs" Inherits="UI_UnitSaleEntryWithMoneyRct" Title=" Unit Sale Entry Form (Design and Developed by Sakhawat)" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" 
      ...
      <div id="dvContent" runat="server">
          <%--  <asp:UpdatePanel ID="HolderInfoUpdatePanel" runat="server">--%>     <%-- <ContentTemplate>--%>
    ...
    <tr>
        ...
        <td align="left">
            <asp:TextBox ID="saleNumberTextBox" runat="server" 
                ...
                onkeypress="fncInputNumericValuesOnly()" Height="18px" Width="76px"></asp:TextBox>
        ...
        <td align="left"><table>
            <tr>
                ...
                <asp:ListItem Value="PO">PO</asp:ListItem>
                 ...
                 <td  align="center">
                   <asp:RadioButton ID="CashRadioButton" runat="server" 
   ...
   <tr>
     ...
     <tr>
        <td class="auto-style2">Selling Agent Code:</td>
